...
__all__ = ['Ackley1', 'Ackley4', 'Alpine1', 'Alpine2', 'Bohachevsky', 'Brent', 'Brown', 'CarromTable', 'ChungReynolds',
           ...
           'Zakharov', 'ZeroSum', "F3_MODIFIED", "F1_MODIFIED"]
...
class BasicProblem:
    ...
    def get_func_val(self, variables, *args):
        ...
        raise NotImplementedError("subclass implementation is missing.")
    ...
    def max_distance(self):
        return distance.euclidean(self.min_search_range,  self.max_search_range)
...
class Ackley1(BasicProblem):
    def __init__(self, variable_num, minf = -35., maxf = 35.):
        super().__init__(variable_num)
        self.max_search_range = np.array([maxf] * self.variable_num)
        self.min_search_range = np.array([minf] * self.variable_num)
        self.optimal_solution = np.array([0.] * self.variable_num)
...
class Alpine1(BasicProblem):
    def __init__(self, variable_num, minf = -10., maxf = 10.):
        super().__init__(variable_num)
        self.max_search_range = np.array([maxf] * self.variable_num)
        self.min_search_range = np.array([minf] * self.variable_num)
        self.optimal_solution = np.array([0.] * self.variable_num)
...
class Alpine2(BasicProblem):
    def __init__(self, variable_num, minf = 0., maxf = 10.):
        super().__init__(variable_num)
        self.max_search_range = np.array([maxf] * self.variable_num)
        self.min_search_range = np.array([minf] * self.variable_num)
...
class Brown(BasicProblem):
    def __init__(self, variable_num, minf = -1., maxf = 4.):
        super().__init__(variable_num)
        self.max_search_range = np.array([maxf] * self.variable_num)
        self.min_search_range = np.array([minf] * self.variable_num)
        self.optimal_solution = np.array([0.] * self.variable_num)
...
class Brent(BasicProblem):
    def __init__(self, variable_num, minf = -20., maxf = 0.):
        super().__init__(variable_num)
        self.max_search_range = np.array([maxf] * self.variable_num)
        self.min_search_range = np.array([minf] * self.variable_num)
...
class ChungReynolds(BasicProblem):
    def __init__(self, variable_num, minf = -100., maxf = 100.):
        super().__init__(variable_num)
        self.max_search_range = np.array([maxf] * self.variable_num)
        self.min_search_range = np.array([minf] * self.variable_num)
        self.optimal_solution = np.array([0.] * self.variable_num)
...
class Csendes(BasicProblem):
    def __init__(self, variable_num, minf = -2., maxf = 2.):
        super().__init__(variable_num)
        self.max_search_range = np.array([maxf] * self.variable_num)
        self.min_search_range = np.array([minf] * self.variable_num)
        self.optimal_solution = np.array([0.] * self.variable_num)
...
class CosineMixture(BasicProblem):
    def __init__(self, variable_num, minf = -1., maxf = 1.):
        super().__init__(variable_num)
        self.max_search_range = np.array([maxf] * self.variable_num)
        self.min_search_range = np.array([minf] * self.variable_num)
        self.optimal_solution = np.array([0.] * self.variable_num)
...
class Deb2(BasicProblem):
    def __init__(self, variable_num, minf = 0., maxf = 1.):
        super().__init__(variable_num)
        self.max_search_range = np.array([maxf] * self.variable_num)
        self.min_search_range = np.array([minf] * self.variable_num)
...
class DropWave(BasicProblem):
    def __init__(self, variable_num, minf = -5.12, maxf = 5.12):
        super().__init__(variable_num)
        self.max_search_range = np.array([maxf] * self.variable_num)
        self.min_search_range = np.array([minf] * self.variable_num)
        self.optimal_solution = np.array([0.] * self.variable_num)
...
class EggHolder(BasicProblem):
    def __init__(self, variable_num, minf = -512., maxf = 512.):
        super().__init__(variable_num)
        self.max_search_range = np.array([maxf] * self.variable_num)
        self.min_search_range = np.array([minf] * self.variable_num)
...
class Vincent(BasicProblem):
    def __init__(self, variable_num, minf = 0.25, maxf = 10.):
        super().__init__(variable_num)
        self.max_search_range = np.array([maxf] * self.variable_num)
        self.min_search_range = np.array([minf] * self.variable_num)
        self.optimal_solution = np.array([0.] * self.variable_num)
...
# https://www.sciencedirect.com/science/article/pii/S0950705119300188?via%3Dihub#tbl4

class F3_MODIFIED(BasicProblem):
    def __init__(self, variable_num, k = 1, minf = -100, maxf = 100):
        super().__init__(variable_num)
        self.k = k
        self.max_search_range = np.array([maxf] * self.variable_num)
        self.min_search_range = np.array([minf] * self.variable_num)
        self.optimal_solution = np.array([k] * self.variable_num)
        self.global_optimum_solution = 0.
        self.func_name = 'Rastrigin'
        self.features = {'Continuous': True,
                         'Differentiable': True,
    ...
    def get_func_val(self, variables, *args):
        return sum([(pos+1)*(value - self.k)**2 for pos, value in enumerate(variables)])

class F1_MODIFIED(BasicProblem):
    def __init__(self, variable_num, k = 1, minf = -100, maxf = 100):
        super().__init__(variable_num)
        self.k = k
        self.max_search_range = np.array([maxf] * self.variable_num)
    ...
    def get_func_val(self, variables, *args):
        return sum([value - self.k for pos, value in enumerate(variables)])
